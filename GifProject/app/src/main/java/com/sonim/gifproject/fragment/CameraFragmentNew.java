...
public class CameraFragmentNew extends Fragment
    ...
    private static final String TAG = "CameraFragmentNew";
...
//                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
    ...
    /**
     * Opens the camera specified by {@link CameraFragmentNew#mCameraId}.
     */
...
//            requestCameraPermission();
        ...
        try {
           /* if (!mCameraOpenCloseLock.tryAcquire(2500, TimeUnit.MILLISECONDS)) {
            ...
            Log.d(TAG,"CameraId from Open Camera :"+mCameraId);
